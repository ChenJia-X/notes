...
![举个例子](http://ww4.sinaimg.cn/large/52eb2279jw1f2rx409pcnj2044048mx5.jpg)
...
- `map()`: 事件对象的直接变换，具体功能上面已经介绍过。它是 RxJava 最常用的变换。 `map()` 的示意图：![map() 示意图](http://ww1.sinaimg.cn/mw1024/52eb2279jw1f2rx4fitvfj20hw0ea0tg.jpg)
...
赞助方：[周伯通招聘](http://jobtong.com/) 

是他们让我的文章能够以不那么丑陋的样子出现在大家面前。